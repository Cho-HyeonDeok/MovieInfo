...
<div class="title_font">
   ...
   <form id="movieInfo" method="post">
      <div class="label_font_size">
         <label class="label_font">영화코드</label>
      </div>
      <div>
      	<input name="m_code">
      </div>
      ...
      <div class="label_font_size">
         <label class="label_font">제목</label>
      </div>
      <div>
      <input name="title">
      </div>
      <div class="label_font_size">
         <label class="label_font">기존 제목</label>
      </div>
      	<div>
      		<input name="original_title">
      	</div>
      <div class="label_font_size">
         <label class="label_font">러닝타임</label>
      </div>
      	<div>
      		<input name="runtime">
      	</div>
      ...
      <div><input name="showdate"></div>
      
      	<div class="label_font_size">
         <label class="label_font">영화 상영 구분</label>
      </div>
      ...
      <div class="label_font_size">
         <label class="label_font">영상 링크 여부</label>
      </div>
      <div><input name="video"></div>
  
   </form>
   </div>
   <div class="row justify-content-center">
   	<div class="just_for_padding">
      <input type="button" id="enroll_button" class="btn btn-black" value="확인">
      <button type="button" onclick="location.href='/admin/movieList'" class="btn btn-white">취소</button>
  		</div>

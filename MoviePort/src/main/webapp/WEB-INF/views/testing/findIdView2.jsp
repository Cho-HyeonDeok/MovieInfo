 ...
 <div class="untree_co-section pb-0" id="home-section">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <h1 class="heading gsap-reveal-hero mb-3"><strong>YourIdPort<span class="text-primary">.</span></strong></h1>
          <h2 class="subheading gsap-reveal-hero mb-4">
            Your Id in here</strong>.
          </h2>
               ...
               <form id="findForm" method="post">
                ...
                <div class="row" style="padding-bottom: 25px;">
                 <div class="col-12 form-group">
                 	...
                 	<span id="pwdUpdate_text_1">회원님의 아이디는</span><span id="pwdUpdate_text_1" style="color: blue">${member.id}</span><span id="pwdUpdate_text_1">입니다.</span>
				  ...
				  <!--가입 및 취소 버튼-->
	                <div class="col-12 form-group">
	                  <button type="button" class="btn btn-black" onclick="location.href='/member/findPwdCheck'">비밀번호 찾기</button>

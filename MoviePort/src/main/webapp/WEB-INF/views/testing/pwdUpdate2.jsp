 ...
 <div class="untree_co-section pb-0" id="home-section">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <h1 class="heading gsap-reveal-hero mb-3"><strong>MyPasswordPort<span class="text-primary">.</span></strong></h1>
          <h2 class="subheading gsap-reveal-hero mb-4">
            Change Password in here</strong>.
          </h2>
               ...
               <form id="pwdChange" method="post">
                ...
                <div class="row" style="padding-bottom: 25px;">
                 <div class="col-12 form-group">
                 	...
                 	<span id="pwdUpdate_text_1">새 비밀번호</span>
                 ...
                 <div class="col-12 form-group">
                 	<div class="pwdUpdate_text">
                 	<span id="pwdUpdate_text_1">새 비밀번호 확인</span>
                  <input type="password"  id="pwdck" class="form-control" placeholder="New Password Check">
                     </div>
                </div>
                 </div>
				  ...
				  <!--가입 및 취소 버튼-->
	                <div class="col-12 form-group">
	                  <input type="button"  id="update_button" class="btn btn-black" value="submit">

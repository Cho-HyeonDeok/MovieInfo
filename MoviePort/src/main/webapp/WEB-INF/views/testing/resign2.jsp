 ...
 <div class="untree_co-section pb-0" id="home-section">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <h1 class="heading gsap-reveal-hero mb-3"><strong>ByeByePort<span class="text-primary">.</span></strong></h1>
          <h2 class="subheading gsap-reveal-hero mb-4">
            See you later in here</strong>.
          </h2>
               ...
               <form id="myInfo" method="post">
                ...
                <div class="row" style="padding-bottom: 25px;">
                 <div class="col-12 form-group">
                 	...
                 	<span id="pwdUpdate_text_1">아이디</span>
                  <input type="text" id="id" name="id" class="form-control" value="${info.id}" placeholder="Id" readonly="readonly">
                    </div>
                </div>
                 </div>
                 ...
                 <div class="col-12 form-group">
                 	<div class="pwdUpdate_text">
                 	<span id="pwdUpdate_text_1">이메일</span>
				  ...
				  <!--가입 및 취소 버튼-->
	                <div class="col-12 form-group">
	                  <input type="button"  id="delete_button" class="btn btn-black" value="Leave">
	                  <button type="button" class="btn btn-white" onclick="location.href='/mypage/mypageMain'">cancel</button>
	                </div>

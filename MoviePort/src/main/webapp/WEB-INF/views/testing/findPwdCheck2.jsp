 ...
 <div class="untree_co-section pb-0" id="home-section">
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-7">
          <h1 class="heading gsap-reveal-hero mb-3"><strong>FindPasswordPort<span class="text-primary">.</span></strong></h1>
          <h2 class="subheading gsap-reveal-hero mb-4">
            Find Password in here</strong>.
          </h2>
               ...
               <form id="findForm" method="post">
                ...
                <div class="row" style="padding-bottom: 25px;">
                 ...
                 <div class="col-12 form-group">
				  ...
				  <!--가입 및 취소 버튼-->
	                <div class="col-12 form-group">
	                  <input type="button"  id="find_pwd_button" class="btn btn-black" value="비밀번호 찾기">

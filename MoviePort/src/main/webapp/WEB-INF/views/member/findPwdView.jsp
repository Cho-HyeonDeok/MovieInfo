						...
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<span id="pwdUpdate_text_1">아래의 이메일로 임시 비밀번호가 발송되었습니다.</span> <span
										id="pwdUpdate_text_1" style="color: blue">${email}</span> <br>
									<span id="pwdUpdate_text_1">임시 비밀번호로 로그인 후 반드시 비밀번호를
										변경해주세요▼</span>

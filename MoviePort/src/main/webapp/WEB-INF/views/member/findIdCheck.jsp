				...
				<div class="col-4 col-sm-5 col-md-5 col-lg-4">
					<form id="findForm" method="post">
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">이름</span> --> <input type="text"
						...
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">휴대폰 번호</span> --> <input type="text"
						...
						<div class="row justify-content-center text-center"
							...
							<!--가입 및 취소 버튼-->
							<div class="col-12 form-group">
								<input type="button" id="find_id_button" class="btn btn-black"
									value="아이디 찾기">

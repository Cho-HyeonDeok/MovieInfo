  ...
  <nav class="site-nav dark mb-5 site-navbar-target">
    <div class="container">
      <div class="site-navigation">
        <a href="/testing/index" class="logo m-0">Minimal<span class="text-primary">.</span></a>

        <ul class="js-clone-nav d-none d-lg-inline-none site-menu float-right site-nav-wrap">
          <li><a href="/testing/index#home-section" class="nav-link active">Home</a></li>
          <li><a href="/testing/index#portfolio-section">Portfolio</a></li>

          <li class="has-children">
            <a href="/testing/index#about-section">About</a>
            <ul class="dropdown">
          ...
          <li><a href="/testing/index#services-section">Services</a></li>
          <li><a href="/testing/index#contact-section">Contact us</a></li>
        </ul>
            ...
            <div class="col-lg-6">
              ...
              <div class="custom-block" data-aos="fade-up">
                ...
                <div class="row gutter-v2 gallery">
                  <div class="col-4">
                    <a href="images/gal_1.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_1.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-4">
                    <a href="images/gal_2.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_2.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-4">
                    <a href="images/gal_3.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_3.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-4">
                    <a href="images/gal_4.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_4.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-4">
                    <a href="images/gal_5.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_5.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="col-4">
                    <a href="images/gal_6.jpg" class="gal-item" data-fancybox="gal"><img src="../resources/assets/images/gal_6.jpg" alt="Image" class="img-fluid"></a>
                  </div>
                </div>
              </div> <!-- END .custom-block -->
              ...
              <div class="custom-block" data-aos="fade-up">
                ...
                <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
                  ...
                  <img src="../resources/assets/images/portfolio_1.jpg" alt="Image" class="img-fluid rounded">
                </a>
              </div> <!-- END .custom-block -->
            ...
            <div class="col-lg-6">
              ...
              <div class="custom-block" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="owl-single owl-carousel no-nav">
                  ...
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="../resources/assets/images/person_4.jpg" alt="Image" class="img-fluid">
                    </figure>

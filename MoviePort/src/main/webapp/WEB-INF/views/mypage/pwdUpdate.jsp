				...
				<div class="col-4 col-sm-5 col-md-5 col-lg-4">
					...
					<form id="pwdChange" method="post">
						...
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">새 비밀번호</span> --> <input
						...
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">새 비밀번호 확인</span> --> <input
										type="password" id="pwdck" class="form-control"
						...
						<div class="row justify-content-center text-center"
							...
							<div class="col-12 form-group">
								...
								<!-- <button type="button" class="btn btn-white"
									onclick="location.href='/mypage/mypageMain'">cancel</button> -->
							</div>
						</div>
					</form>
				</div>

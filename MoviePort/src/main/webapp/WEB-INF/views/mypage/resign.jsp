				...
				<div class="col-3 col-sm-3 col-md-3 col-lg-4">
					<form id="myInfo" method="post">
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">아이디</span> --> <input type="text"
										id="id" name="id" class="form-control" value="${info.id}"
						...
						<div class="row" style="padding-bottom: 25px;">
							<div class="col-12 form-group">
								<div class="pwdUpdate_text">
									<!-- <span id="pwdUpdate_text_1">이메일</span> --> <input type="text"
						...
						<div class="row justify-content-center text-center"
							...
							<div class="col-12 form-group">
								...
								<!-- <button type="button" class="btn btn-white"
									onclick="location.href='/mypage/mypageMain'">취소</button> -->
							</div>
						</div>
					</form>
				</div>
